...
void iap_write_appbin(u32 WriteAddr,u8 *pBuffer,u32 NumToWrite)
{
    ...
    if (WriteAddr < 0x08000000 || (WriteAddr >= (0x08000000 + 1024 * 64)))
    {
        printf("地址越界!\r\n");
        return;   
    }
...
void iap_load_app(u32 appxaddr)
{
	...
	{ 
        ...
        ((SysTick_Type *) ((0xE000E000) + 0x0010))->LOAD = 0;
        ((SysTick_Type *) ((0xE000E000) + 0x0010))->VAL = 0;
        ...
        for (i = 0; i < 8; i++)
        {
            ((NVIC_Type *) ((0xE000E000) + 0x0100))->ICER[i]=0xFFFFFFFF;
            ((NVIC_Type *) ((0xE000E000) + 0x0100))->ICPR[i]=0xFFFFFFFF;
        }
