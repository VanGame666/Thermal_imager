#line 1 "..\\Drivers\\stmflash.c"
#line 1 "..\\Drivers\\stmflash.h"
...
{    
    ...
    while(1)
    {
        ...
        {
            FLASH_ErasePage(WriteAddr); 
            STMFLASH_Write_NoCheck(WriteAddr, pBuffer, 1024 / 2); 
