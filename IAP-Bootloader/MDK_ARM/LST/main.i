...
#line 2 "..\\Applications\\main.c"
#line 3 "..\\Applications\\main.c"
...
#line 4 "..\\Applications\\main.c"
#line 1 "..\\Applications\\IAP\\iap.h"
#line 4 "..\\Applications\\IAP\\iap.h"
#line 5 "..\\Applications\\IAP\\iap.h"
...
#line 5 "..\\Applications\\main.c"
#line 1 "..\\Drivers\\can.h"
#line 4 "..\\Drivers\\can.h"
...
#line 6 "..\\Applications\\main.c"
#line 1 "..\\Drivers\\timer.h"
#line 4 "..\\Drivers\\timer.h"
...
int main(void)
{
    ...
    uart_init(115200);	
    delay_init();	   	
    CAN_Mode_Init(((uint8_t)0x00),((uint8_t)0x07),((uint8_t)0x08),2,((uint8_t)0x00));
    ...
    while(1)
    {
        if(TickMs > 3000)
        {
            ...
            if(((*(vu32*)(0x08004000+4))&0xFF000000)==0x08000000)
            {
    ...
    while(1)
    {
        if(CANRecFlag)
        {
            ...
            if(RxMessage.StdId == 0x02)
            {
                ...
                {
                    printf("开始更新固件...\r\n");
                    if(((*(vu32*)(APP_RX_BUF+4))&0xFF000000)==0x08000000)
                    {
                        iap_write_appbin(0x08004000,APP_RX_BUF,APPLength);
                        printf("固件更新完成!\r\n");
                    }
                    else
                    {
